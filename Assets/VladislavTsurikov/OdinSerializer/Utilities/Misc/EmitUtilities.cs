...
#if NET_STANDARD_2_0
#error Odin Serializer is incapable of compiling source code against the .NET Standard 2.0 API surface. You can change the API Compatibility Level in the Player settings.
#endif
