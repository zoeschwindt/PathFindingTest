...
{
	[Template("Cliffs/Small Rocks", new Type[]{typeof(AdvancedBrushTool.ScriptsEditor.AdvancedBrushTool), typeof(TerrainSpawner.Scripts.TerrainSpawner)}, 
	...
	public class SmallCliffs : Template
	{
		protected override void Apply(Group group)
    	{
            ...
            MaskOperationsFilter invertFilter = (MaskOperationsFilter)filterComponent.MaskFilterComponent.Stack.CreateIfMissing(typeof(MaskOperationsFilter));
		...
		protected override void Apply(Prototype proto)
    	{
    		...
    		overlapCheckComponent.OverlapShape = OverlapShape.None;
    		#endregion
		}
	}
}
