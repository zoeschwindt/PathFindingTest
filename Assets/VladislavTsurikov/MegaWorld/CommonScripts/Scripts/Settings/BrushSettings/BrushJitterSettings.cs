...
namespace VladislavTsurikov.MegaWorld.CommonScripts.Scripts.Settings.BrushSettings
{
    ...
    public class BrushJitterSettings 
    {
        ...
        public AreaVariables GetAreaVariables(BrushComponent brush, Vector3 point, Group group)
        {
            ...
            areaVariables.RayHit = RaycastUtility.Raycast(RayUtility.GetRayDown(point), layerSettings.GetCurrentPaintLayers(group.PrototypeType));
