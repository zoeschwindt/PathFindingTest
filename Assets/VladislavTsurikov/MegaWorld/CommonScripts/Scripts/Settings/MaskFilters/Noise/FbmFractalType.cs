...
namespace VladislavTsurikov.MegaWorld.CommonScripts.Scripts.Settings.MaskFilters.Noise
{
    ...
    public class FbmFractalType : FractalType<FbmFractalType>
    {
        ...
        {
            name = "Fbm",
            templatePath = "Assets/VladislavTsurikov/MegaWorld/CommonScripts/Scripts/Settings/MaskFilters/Shaders/NoiseLib/Templates/FractalFbm.noisehlsltemplate",
            ...
            {
                "Assets/VladislavTsurikov/MegaWorld/CommonScripts/Scripts/Settings/MaskFilters/Shaders/NoiseLib/NoiseCommon.hlsl"
            }
        };
